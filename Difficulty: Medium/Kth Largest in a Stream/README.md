...
After 4, the elements are [<span style="text-decoration: underline;">1</span>, 2, 3, 4]. The 4th largest element is 1.
After 5, the elements are [1, <span style="text-decoration: underline;">2</span>, 3, 4, 5]. The 4th largest element is 2.
After 6, the elements are [1, 2, <span style="text-decoration: underline;">3</span>, 4, 5, 6]. The 4th largest element is 3.</span></span></span></pre>
...
After 2, the elements are [3, <span style="text-decoration: underline;">2</span>]. The 2nd largest element is 2.
After 1, the elements are [3, <span style="text-decoration: underline;">2</span>, 1]. The 2nd largest element is 2.
After 3, the elements are [3, 2, 1, <span style="text-decoration: underline;">3</span>]. The 2nd largest element is 3.
After 3, the elements are [3, 2, 1, <span style="text-decoration: underline;">3</span>, 3]. The 2nd largest element is 3.</span></pre>
